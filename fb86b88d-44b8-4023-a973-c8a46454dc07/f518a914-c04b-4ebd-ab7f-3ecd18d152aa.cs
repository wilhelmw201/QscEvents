//本文件填写BattleEvent_Entry选项f518a914-c04b-4ebd-ab7f-3ecd18d152aa在事件执行周期内的相关阶段函数
...
public class EventOption_f518a914c04b4ebdab7f3ecd18d152aa : Event_fb86b88d44b84023a973c8a46454dc07
{
#endif
    ...
    private string OnSelect()
    {
        ...
        EditorBattleEvent Event = (EditorBattleEvent)ev;
        int roll = QscCoreUtils.RandInt32(this.TaiwuEvent ,0, 100, "");
        if (roll <= Event.escapeChance)
        {
            return "d6da980c-bb42-46fe-9aa4-0a175589c270";
        }
        else
        {
            return "474b80dd-02ff-46e8-8c39-5e9087a23cc8";
        }
