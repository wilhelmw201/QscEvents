//本文件填写BattleEvent_2成功逃脱选项71727043-49f2-406b-ad9e-7ed8214a7a3c在事件执行周期内的相关阶段函数
...
public class EventOption_7172704349f2406bad9e7ed8214a7a3c : Event_d6da980cbb4246fe9aa40a175589c270
{
#endif
    ...
    private string OnSelect()
    {
        ...
        if (Event.DestOnEscape == null)
        {
            return "185644c3-ec94-45cb-a3dc-a31e600632ed";
        }

        return QscCoreUtils.CallEvent(Event.DestOnEscape, "185644c3-ec94-45cb-a3dc-a31e600632ed");
