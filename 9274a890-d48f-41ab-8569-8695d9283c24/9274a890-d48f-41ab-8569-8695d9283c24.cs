...
#if IN_IDE
public class Event_9274a890d48f41ab85698695d9283c24 : TaiwuEventItem
{
#endif
    ...
    {
        EditorSimpleLootEvent ev = (EditorSimpleLootEvent) QscCoreUtils.EventList.Last();
        ev.current = 0;
        
        EventHelper.ToEvent("538db91b-072b-4b0b-943d-c0ea9a40be6e");
    }
