//本文件填写GetGoldEvent_0(Clone)事件执行周期内相关阶段函数
...
#if IN_IDE
public class Event_73479eab8c224ad581ef3d3072773532 : TaiwuEventItem
{
#endif
    ...
    {
        HealingEvent Event = (HealingEvent)QscCoreUtils.EventList.Last();


        var injuries = DomainManager.Taiwu.GetTaiwu().GetInjuries();

        for (int i = 0; i < 7; i++)
        {
            injuries.Change((sbyte)i, true, (sbyte)-Event.healCount);
            injuries.Change((sbyte)i, false, (sbyte)-Event.healCount);
