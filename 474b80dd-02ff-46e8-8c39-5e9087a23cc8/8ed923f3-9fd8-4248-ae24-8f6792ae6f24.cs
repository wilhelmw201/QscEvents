//本文件填写BattleEvent_2逃跑失败选项8ed923f3-9fd8-4248-ae24-8f6792ae6f24在事件执行周期内的相关阶段函数
...
public class EventOption_8ed923f39fd84248ae248f6792ae6f24 : Event_474b80dd02ff46e88c395e9087a23cc8
{
#endif
    ...
    private string OnSelect()
    {
        ...
        int enemyId = -1;
        ArgBox.Get("BattleEventEnemy", ref enemyId);

        EventHelper.StartCombat(enemyId, Config.CombatConfig.DefKey.DieNormal, "5191e71d-bc5d-4e5d-b5cf-54e425bef5c8", ArgBox);
