//本文件填写2PlayerSelectEvent_0Entry(Clone)事件执行周期内相关阶段函数
...
#if IN_IDE
public class Event_1349f475ab704d8ca22842717a5b02ff : TaiwuEventItem
{
#endif
    ...
    {
        ForgeEvent Event = (ForgeEvent)QscCoreUtils.EventList.Last();
        ...
        Filter.Key = "QscForgeSel";
        EventHelper.SelectCharacterItemRequest(DomainManager.Taiwu.GetTaiwuCharId(), ArgBox, Filter);
