//本文件填写ForgeEvent_0选择选项ec66c7de-ef15-44d5-8237-2243bc7d378b在事件执行周期内的相关阶段函数
...
using Qsc;
public class EventOption_ec66c7deef1544d582372243bc7d378b : Event_1349f475ab704d8ca22842717a5b02ff
{
#endif
    ...
    private string OnSelect()
    {
        ...
        ArgBox.Get("QscForgeSel", out ItemKey selected);
        var Base = DomainManager.Item.GetBaseItem(selected);
        if (Base.GetItemType() == 5 && Base.GetTemplateId() <= 55)
        {
            EventHelper.RemoveInventoryItem(DomainManager.Taiwu.GetTaiwu(), selected);
            return "024f1057-6d1c-4372-9147-707a239cb329";
        }
        else
        {
            return "4111ac69-f3ec-4acb-aa90-eb1a916dc793";
        }
