//本文件填写BattleEvent_2战胜敌人选项105329a2-92b6-4c4e-90e9-3a3ed522adc0在事件执行周期内的相关阶段函数
...
public class EventOption_105329a292b64c4e90e93a3ed522adc0 : Event_209dff44822e4ec7982ceffc2ac30e67
{
#endif
    ...
    private string OnSelect()
    {
        ...
        EditorBattleEvent Event = (EditorBattleEvent)QscCoreUtils.EventList.Last();
        if (Event.DestOnWin == null)
        {
            AdaptableLog.Info("win battle! next is null. returning");
            return "185644c3-ec94-45cb-a3dc-a31e600632ed";
        }
        AdaptableLog.Info("win battle! going to" + Event.DestOnWin);
        return QscCoreUtils.CallEvent(Event.DestOnWin, "185644c3-ec94-45cb-a3dc-a31e600632ed");
    }
