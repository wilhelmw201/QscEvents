//本文件填写ForgeEvent_1成功选项89fa8051-17e0-4e98-a7bf-e3af87a14713在事件执行周期内的相关阶段函数
...
using Qsc;
public class EventOption_89fa805117e04e98a7bfe3af87a14713 : Event_024f10576d1c43729147707a239cb329
{
#endif
    ...
    private string OnSelect()
    {
        ...
        EditorSimpleLootGenEvent NewEv = new EditorSimpleLootGenEvent(Event.table, -1, 100);
        return QscCoreUtils.CallEvent(NewEv);
    }
